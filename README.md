...
## Tecnologias
- ** OS :** [VirtualBox Linux Mint]
- ** Shell :** Bash 5. x
- ** VCS :** Git 2. x
- ** Editor :** vim / nano
- ** Hosting :** GitHub
## Contacto
- Email : [andrea.bernal@sistemas.edu.bo]
- GitHub : https://github.com/andreabernal-png
- LinkedIn : [andreabernal-png]
